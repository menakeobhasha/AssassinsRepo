<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Adviser.aspx.cs" Inherits="StockMarketSimulation.Pages.Adviser" %>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Adviser Name:</label>
                                <div class="col-sm-2">
                                    <asp:TextBox ID="txtAdviserName" runat="server" CssClass="form-control" class="control-label" AutoPostBack="true" onkeydown="return ((event.keyCode>=48 && event.keyCode<=57) || (event.keyCode>=96 && event.keyCode<=105) || (event.keyCode==8 || event.keyCode==9));"></asp:TextBox>
                                </div>
                                <label class="col-sm-1 control-label">Adviser Type:</label>
                                <div class="col-sm-2">
                                    <asp:DropDownList ID="ddlAdviserType" runat="server" CssClass="form-control"></asp:DropDownList>
                                </div>
                                <div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <asp:Button ID="btnAddAdviser" runat="server" Text="Add Record" CssClass="btn btn-success" OnClick="btnAddAdviser_Click" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12">
                                    <asp:GridView ID="gvAdviser" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover" AllowPaging="True" OnRowCommand="gvAdviser_RowCommand">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Adviser Id" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblAdviserId" runat="server" Text='<%# Bind("AdviserId") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Adviser Name">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblName" runat="server" Text='<%# Bind("Name") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Adviser Type">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblType" runat="server" Text='<%# Enum.GetName(typeof(SMS.Common.AdviserType),Convert.ToInt32(Eval("Type")))%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
