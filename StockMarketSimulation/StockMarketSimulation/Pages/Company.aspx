                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <asp:TextBox ID="txtCompanyName" runat="server" CssClass="form-control" class="control-label" AutoPostBack="true" ></asp:TextBox>
                                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            Validate = function () {
                ...
                $('#<% = txtNoOfShares.ClientID %>').addClass('validate[required]');//,custom[integer]
                $('#<% = txtSharePrice.ClientID %>').addClass('validate[required]');
