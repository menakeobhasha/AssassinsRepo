<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Broker.aspx.cs" Inherits="StockMarketSimulation.Pages.Broker" %>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <asp:TextBox ID="txtBrokerName" runat="server" CssClass="form-control" class="control-label" AutoPostBack="true" onkeydown="return ((event.keyCode>=48 && event.keyCode<=57) || (event.keyCode>=96 && event.keyCode<=105) || (event.keyCode==8 || event.keyCode==9));"></asp:TextBox>
                                </div>
                                <label class="col-sm-1 control-label">Broker Type:</label>
                                <div class="col-sm-2">
                                    <asp:DropDownList ID="ddlBrokerType" runat="server" CssClass="form-control"></asp:DropDownList>
                                </div>
                                <div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <asp:Button ID="btnAddBroker" runat="server" Text="Add Record" CssClass="btn btn-success" OnClick="btnAddBroker_Click" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12">
                                    <asp:GridView ID="gvBroker" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover" AllowPaging="True" OnRowCommand="gvBroker_RowCommand">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Broker Id" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblBrokerId" runat="server" Text='<%# Bind("BrokerId") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Broker Type">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblType" runat="server" Text='<%# Enum.GetName(typeof(SMS.Common.BrokerType),Convert.ToInt32(Eval("Type")))%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            Validate = function () {
                ...
                $('#<% = txtJoinDate.ClientID %>').addClass('validate[required]');//,custom[integer]
